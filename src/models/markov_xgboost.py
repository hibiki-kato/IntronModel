...
def _train_pair_markov_xgboost(
    *,
    ...
    return {
        ...
        "best_pr_auc": val_metrics.get("pr_auc"),
        "best_roc_auc": val_metrics.get("roc_auc"),
        "best_max_f1": val_metrics.get("max_f1"),
        "best_acc_at_0_5": val_metrics.get("acc@0.5"),
        ...
        "epoch_history": [
            {
                ...
                "acc@0.5": val_metrics.get("acc@0.5"),
                "objective_metric": best_metric,
