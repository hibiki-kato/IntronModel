...
if [[ $# -gt 0 ]]; then
	echo "[cnn_resdil.sh] This script is config-only. Edit top CONFIG and run without args." >&2
	exit 1
fi
...
TAG=""
# MASK_MODE="on"
# MASK_TEST_TSV_PATH="data/{species}/processed/transcripts_with_intron_half.tsv"
VISUALIZE="true"
SKIP_TRAINING="0"
CONTINUE_TRAINING="0"
TRAIN_ONLY="0"
