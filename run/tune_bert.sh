...
intronmodel_start_timer "tune_bert.sh"
trap 'intronmodel_print_timing' EXIT

resolve_species_case() {
	intronmodel_resolve_species_case "$1" "$2" "tune_bert.sh"
}

resolve_tune_targets() {
	intronmodel_resolve_tune_targets "$1" "tune_bert.sh"
}

resolve_python_bin() {
	intronmodel_resolve_python_bin "tune_bert.sh"
}
