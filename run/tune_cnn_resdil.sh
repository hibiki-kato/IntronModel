...
intronmodel_start_timer "tune_cnn_resdil.sh"
trap 'intronmodel_print_timing' EXIT

resolve_species_case() {
	intronmodel_resolve_species_case "$1" "$2" "tune_cnn_resdil.sh"
}

resolve_tune_targets() {
	intronmodel_resolve_tune_targets "$1" "tune_cnn_resdil.sh"
}
