...
def test_checkpoint_tasks_for_model_supports_pair_override() -> None:
    ...
    assert checkpoint_tasks_for_model("cnn_pair_cheat") == ("pair",)
    assert checkpoint_tasks_for_model("cnn_pair_mask") == ("pair",)
    assert checkpoint_tasks_for_model("cnn_pair_mask_cheat") == ("pair",)
    assert checkpoint_tasks_for_model("cnn_pair_v2") == ("pair",)
    assert checkpoint_tasks_for_model("cnn_pair_v3") == ("pair",)
    assert checkpoint_tasks_for_model("cnn_v2_pair") == ("pair",)
    assert checkpoint_tasks_for_model("cnn_v3_meta") == ("pair",)
    assert checkpoint_tasks_for_model("bilstm_pair") == ("pair",)
    assert checkpoint_tasks_for_model("bilstm_pair_mask") == ("pair",)
    assert checkpoint_tasks_for_model("markov_xgboost") == ("pair",)
    assert checkpoint_tasks_for_model("dnabert2_pair") == ("pair",)
    assert checkpoint_tasks_for_model("dnabert2_pair_trunc") == ("pair",)
    assert checkpoint_tasks_for_model("dnabert2_pair_trunc_cheat") == ("pair",)
